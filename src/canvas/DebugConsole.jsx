...
import { subscribeDebugLog, clearDebugLog } from './debugLog.js';
...
export default function DebugConsole() {
  ...
  useEffect(() => {
    const onKeyDown = (e) => {
      // Don't hijack the key while someone's actually typing into a text
      // field — only treat it as the console toggle when focus is
  ...
  return (
    <div className="debug-console">
      ...
      <div className="debug-console-body">
        {entries.length === 0 && <p className="debug-console-empty">nothing logged yet — trigger the muse with its 🔧 debug toggle on</p>}
